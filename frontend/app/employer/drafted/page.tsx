...
export default function EmployerDraftedJobsPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h1 className="text-xl font-semibold text-slate-900">Drafted job postings</h1>
          <p className="mt-1 text-sm text-slate-600">
            Jobs saved as drafts and not yet visible to candidates.
          </p>
        </div>
        <Link
          href="/employer/new"
      ...
      {loading ? (
        ...
        <div className="rounded-xl border border-dashed border-slate-300 bg-slate-50 px-4 py-6 text-center text-sm text-slate-500">
          <p className="font-medium">You have no drafted jobs yet.</p>
          <p className="mt-1 text-xs">You can save a job as draft from the Create Job Listing form.</p>
