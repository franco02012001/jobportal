...
export default function EmployerAccountSettingsPage() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-6">
      <h1 className="mb-6 text-xl font-semibold text-slate-900">Account Settings</h1>
      ...
      <main className="min-w-0 space-y-6">
        ...
        {/* Password */}
        <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
          <h2 className="mb-4 text-lg font-medium text-slate-900">Change password</h2>
          <form onSubmit={handlePasswordSubmit} className="space-y-4">
            ...
            {passwordError && (
              <p className="rounded-md bg-red-50 px-3 py-2 text-xs text-red-700">{passwordError}</p>
            )}
            <div>
