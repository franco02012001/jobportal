...
let JobsController = class JobsController {
    ...
    update(id, user, dto) {
        const u = user;
        const userId = u.id ?? u._id?.toString();
        return this.jobsService.update(id, userId, user.role, dto);
    }
    remove(id, user) {
        const u = user;
        const userId = u.id ?? u._id?.toString();
        return this.jobsService.remove(id, userId, user.role);
    }
};
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [user_schema_1.User, create_job_dto_1.CreateJobDto]),
    __metadata("design:returntype", void 0)
], JobsController.prototype, "create", null);
__decorate([
    (0, common_1.Patch)(':id'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(roles_enum_1.Role.EMPLOYER, roles_enum_1.Role.EMPLOYEE, roles_enum_1.Role.ADMIN),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, current_user_decorator_1.CurrentUser)()),
    __param(2, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, user_schema_1.User,
        update_job_dto_1.UpdateJobDto]),
    __metadata("design:returntype", void 0)
